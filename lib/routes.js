...
console.log('the context you seek...');
console.log(res.context);
    ...
    app.get('/projects/support/:pid', defaultPageContext(), context.projects.instance(),function(req, res) {
        controllers.projects.supportProject(req, res, function(err, context) {
console.log('back from supportProject');
console.log(context);
            res.redirect('/projects/' + context.slug);
        });
    });
