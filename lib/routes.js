...
var set_routes = function(app) {
    ...
    app.get('/', function(req, res) {
        ...
        controllers.Projects.get_all_projects(req, res, function(err, projects_context) {
            ...
            // Views and context
            projects_context.pageTitle = 'Welcome to City Hero';
            projects_context.bodyClasses = ['front', 'home'];
            projects_context.sidebarInnerContent = ['partials/partial.sidebar-home.ejs'];
            projects_context.contentMain = ['pages/content.home.ejs', 'partials/partial.project-slider.ejs'];
            
            prepareContext(req, res, app, projects_context, function(context) {
    ...
    app.get('/projects/wizard', function(req, res) {
        var context = {};
        context = routesSetGlobalContext(app, context);
        context = views.ProjectWizard.getView()
        context = combine(context, site_context, auth_context, sess_context);
