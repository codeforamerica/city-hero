...
exports.setRoutes = function(app) {
    ...
    // User pages
    app.get('/profile/:uid', defaultPageContext(), controllers.users.isOwn(), context.users.profile(), function(req, res) {
        res.render('layout.ejs', res.context);
    });
    app.get('/profile/edit/:uid', defaultPageContext(), controllers.users.isOwn(), 
