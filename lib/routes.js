...
exports.setRoutes = function(app) {
    ...
    // Home page
    app.get('/', defaultPage, views.middlePageContext('/'), function(req, res) {
        res.render('layout.ejs', res.context);
    });

    // Project add wizard
    app.get('/projects/wizard', formPage, views.middlePageContext('/projects/wizard'), function(req, res) {
        res.render('layout.ejs', res.context);
    });
...
//console.log(context);
    ...
    app.get('/search', defaultPage, views.middlePageContext('/'), function(req, res) {
        var q = req.query.q;
        ...
        if(settings.searchMethod === 'es') {
            ...
            http.get(options, function(esResp) {
                esResp.on('data', function(esRespData) {
                    ...
                    res.context.searchResults = h.hits;
