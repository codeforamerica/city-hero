...
exports.setRoutes = function(app) {
    ...
    // Project pages
    app.get('/projects/wizard', formPage, views.projects.wizard(), authenticatedPage, function(req, res) {
        res.render('layout.ejs', res.context);
    });
    ...
    app.get('/projects/edit/:pid', defaultPage, views.projects.edit(), 
    ...
    // User pages
    app.get('/profile/:uid', defaultPage, controllers.users.isOwn(), views.users.profile(), function(req, res) {
        res.render('layout.ejs', res.context);
    });
    app.get('/user/register', defaultPage, views.users.register(), anonymousPage, function(req, res) {
        res.render('layout.ejs', res.context);
    });
    var middleRegister = [
        exports.middleForm(),
    ...
    app.get('/user/login', defaultPage, views.users.login(), anonymousPage, function(req, res) {
        res.render('layout.ejs', res.context);
    });
