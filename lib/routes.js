...
exports.setRoutes = function(app) {
    ...
    var defaultPage = [
        ...
        controllers.session.getSessionContext(), 
    ...
    app.get('/', defaultPage, function(req, res) {
        res.render('layout.ejs', req.context);
    });
...
exports.middleGlobalContext = function() {
    return function (req, res, next) {
        ...
        // Global contexts
        req.context.settings = require('./settings/settings.js');
        req.context.auth = require('./settings/auth.js');
        // Allow settings to be used directly as well
        req.context = combine(req.context, req.context.settings);
        
        // Get messages
        req.context.messages = controllers.session.renderMessages(req, res);
