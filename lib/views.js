 ...
 */
exports.middlePageContext = function (route) {
            ...
            switch (route) {
                case '/':
                    ...
                    controllers.projects.all(function(err, projects) {
                        ...
                        res.context.contentMain = ['pages/content.home.ejs', 'partials/partial.project-slider.ejs'];
                        next();
                    });
                    break;
...
exports.projectDetailsPage = function(pid, /* [getProjectController], */ callback) {
    ...
    getProjectController(pid, function(err, project_context) {
        ...
        if (err && !project_context) {
            console.error('ControllerError for project with id: ' + pid);
            console.error(err);
            callback(err);
            return;
        }
