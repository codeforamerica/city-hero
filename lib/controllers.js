...
console.log('after the save')
    ...
    editOwn: function() {
        return function(req, res, next) {
            ...
            if (res.context.project && res.context.project.owner == req.session.user._id) {
                allowed = true;
            }
    ...
    hasAccess: function(roles) {
        return function (req, res, next) {
            ...
            if (allowed) {
                ...
                exports.session.setMessage(req, res, 'You do not have access to view that page.');
                res.redirect('/');
            }
        }
    },
