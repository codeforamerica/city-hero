    ...
    if (req.params) {
        ...
        if (fields.action && fields.action === 'setowner') {
            ...
            if (fields.video_url) {
                ...
                fields.video_url = fields.video_url.replace('youtu.be/', 'www.youtube.com/embed/');
                
                // If they copied and pasted from the location bar:
                fields.video_url = fields.video_url.replace('www.youtube.com/watch?v=', 'www.youtube.com/embed/');
                
                // Get rid of any parameters after the video id:
                fields.video_url = fields.video_url.replace(/&.+$/, '');
                
                project.video_url = fields.video_url;
            }
        }
